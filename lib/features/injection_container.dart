...
import 'package:taipei_bridge_app/features/bridges/data/repository/bridge_repository_impl.dart';
...
Future<void> initializeDepencies() async {
  ...
  sl.registerSingleton<BirdgeApiService>(BirdgeApiService(sl()));
